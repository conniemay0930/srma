...
# Note: These are stubs for a full application. In a real environment, 
# these would contain the actual API calls.
...
def call_llm_with_prompt(client, model_name: str, system_prompt: str, user_prompt: str, max_output_tokens: int = 4096) -> Optional[str]:
    ...
    # Placeholder implementation
    return "LLM Response Placeholder: All good."
...
# =========================================================
# Main Tabs Layout (The missing part that caused NameError)
# =========================================================
tab_names = [
    t("tab_settings"),
    t("tab_guide"),
...
# *** CRUCIAL FIX: Define the 'tabs' list here ***
...
with tabs[4]:
    ...
    if not studies_df.empty:
        ...
        # START OF MODIFIED LOGIC: Group studies by final_lbl (目標 2b: 分區顯示)
        grouped_studies = {
            "INCLUDE": [],
            "EXCLUDE": [],
            "UNSURE": []
